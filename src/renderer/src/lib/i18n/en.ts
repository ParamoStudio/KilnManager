...
export const en = {
  ...
  app: {
    ...
    whoTitle: "Who is Páramo?",
    whoBody: "Páramo is a small ceramics studio building open-source tools for potters.",
    whoSoon: "Links to the studio, the shop and Ceramic Lab Tools will live here.",

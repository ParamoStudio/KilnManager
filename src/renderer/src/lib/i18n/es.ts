...
export const es: Dictionary = {
  ...
  labWelcome: {
    eyebrow: "Versi\u00f3n web gratuita",
    title: "\u00bfQu\u00e9 es Kiln Manager?",
    lede: "Una herramienta ligera para controlar lo que cuestan las horneadas del horno de tu taller, y para que el servicio de horneada que ofreces a alumnos y clientes sea m\u00e1s f\u00e1cil de llevar y de documentar. Esta es la versi\u00f3n web gratuita \u2014 pru\u00e9bala, o \u00fasala para alguna horneada suelta, aqu\u00ed mismo.",
    featuresHead: "La app de escritorio adem\u00e1s tiene",
    featPhone: "Cargar el horno desde el m\u00f3vil",
    featBook: "Agenda de clientes",
    featUnlimited: "Hornos y horneadas ilimitados",
    featLog: "Registro completo de horneadas",
    featExcel: "Gastos a Excel",
    featLocal: "Todo en tu ordenador",
    privacy: "Todo vive en tu propia m\u00e1quina. Ning\u00fan dato va a nadie m\u00e1s \u2014 nunca. Es c\u00f3digo abierto, as\u00ed que puedes leer cada l\u00ednea en GitHub e incluso compilarlo t\u00fa mismo.",
    continue: "Continuar",
    download: "Descargar la app",
    openSource: "Ver el c\u00f3digo en GitHub",
  },
  lab: {
  ...
  statement: {
    ...
    client: "Cliente",
    month: "Mes",
    firingCount: "Horneadas",
    intro: (client: string, n: number) =>
      `¡Hola ${client}! Este mes has hecho ${n} horneada${n === 1 ? "" : "s"} conmigo. Aquí tienes el detalle.`,
    paidPill: "Pagada",
    provisional: (date: string) =>
      `Resumen provisional a ${date}. El mes aún no ha terminado, así que esto puede cambiar si vuelves a hornear.`,
    alreadyPaid: "Ya pagado este mes",
    total: "TOTAL A PAGAR",
    allPaid: "TODO PAGADO",
  },
  ...
  collections: {
    title: "Cobros",
    hint: "Lo que te deben este mes, junto. Marcar a un cliente aquí lo marca en todas sus horneadas del mes.",
    monthCurrent: "En curso",
    monthLocked: "Aún no ha llegado",
    noMonths: "Aún no has cerrado ninguna horneada, así que no hay nada que cobrar.",
    nothingThisMonth: "Ninguna horneada cerrada este mes.",
    allSettled: "Todo cobrado este mes.",
    outstanding: "Pendiente",
    billed: "Facturado este mes",
    settled: "Al día",
    firingsCount: (n: number) => `${n} horneada${n === 1 ? "" : "s"}`,
    markPaid: "Marcar como pagado",
    unmarkAsk: "Pulsa otra vez para desmarcar",
    paidOn: (date: string) => `Pagado el ${date}`,
    openFiring: "Ver horneada",
    firingPdf: "Factura de esta horneada",
    statementPdf: "PDF del mes",
    exportMessage: "Mensaje de cobros",
    exportOpen: "El mes sigue abierto — el mensaje saldrá marcado como provisional",
    copied: "Copiado",
    copyFailed: "No se pudo copiar",
    savedTo: (path: string) => `Guardado en ${path}`,
    saveFailed: "No se pudo guardar el PDF",
    reportHeading: (month: string) => `Cobros de ${month}`,
    reportIntro: "Esto es lo que tienen que pagar los clientes:",
    reportTotal: "Total:",
    reportNothing: (month: string) => `Nada pendiente de cobro en ${month}.`,
    reportProvisional: (date: string) => `Provisional a ${date} — el mes no ha acabado todavía.`,
  },
